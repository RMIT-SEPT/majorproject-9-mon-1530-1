...
public class GetBlackBoxTests extends BookingBlackBoxHelper {
	...
	public void getAll() throws JsonProcessingException {
		...
		List<RequestParameter> requestParameters = Arrays.asList(new RequestParameter("workerUsername", workerUsername),
	...
	public void getDate() throws JsonProcessingException {
		...
		HashMap<String, String> expected = postWithUsernames(onDate, workerUsername, customerUsername); // Creates records with every username possibility on
																										// todays date

		List<RequestParameter> requestParameters = Arrays.asList(new RequestParameter("date", LocalDate.now().toString()),
				new RequestParameter("workerUsername", workerUsername), new RequestParameter("customerUsername", customerUsername));
