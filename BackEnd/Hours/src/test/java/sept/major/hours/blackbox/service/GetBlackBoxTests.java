...
public class GetBlackBoxTests extends HoursBlackBoxTests {
    ...
    public void getDate() throws JsonProcessingException {
        ...
        postWithUsernames(pastDate, workerUsername, creatorUsername); // Creates records with every username possibility on yesterday's date
        postWithUsernames(futureDate, workerUsername, creatorUsername);  // Creates records with every username possibility on tomorrow's date
        HashMap<String, String> expected = postWithUsernames(onDate, workerUsername, creatorUsername);  // Creates records with every username possibility on todays date
